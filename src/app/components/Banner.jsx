...
<div className="contant-part w-full md:w-1/2 px-4 md:px-0">
    ...
    <h1 className='w-full md:w-[536px] text-2xl sm:text-3xl md:text-4xl lg:text-[56px] text-black font-semibold pb-3 md:pb-5'>Fresh & Healthy Organic Food</h1>
<p className='text-xs sm:text-sm text-black font-normal mb-6 md:mb-8'>
    Free shipping on all your order. we deliver, you enjoy
</p>

<button className='py-2 px-4 sm:py-3 sm:px-6 bg-green-500 rounded-4xl gap-2 flex items-center text-white text-sm sm:text-base hover:bg-green-600 transition'>Shop now <span><FaLongArrowAltRight /></span></button>
</div>
